...
const Team = (props) => {
    ...
    const teamCard = teamInfo.map((member) => {
        const teamSocial = member.links.map((link) => {
            return (
                <a key={link.name} href={link.link}>
                    <i
                        className={`fa-brands fa-${link.name} text-white text-xl mx-2`}
                        aria-hidden='true'
        ...
        return (
            ...
            >
                {/* <div className='mb-16 py-6 rounded-3xl bg-[#29C5E6] lg:bg-[#bdd6d0]'> */}
                {/* <div
                        className='
          relative w-10 h-10 rounded-full mx-auto my-2'
                    > */}
                <Image
    ...
    return (
        <section
            id='team'
            className='m-10 min-h-[320px] rounded-3xl bg-[#fef1e6] md:m-20 md:min-h-[900px] lg:m-12'
        >
